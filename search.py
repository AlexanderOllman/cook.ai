...
chat_history = []
chat_history.append({"role": "user", "content": "Based on ingredients known to be sold and easily available in australia, think of 10 healthy, nutriciously rich recipe that take less than 10 minutes to prepare, serve two people, and share at least 70% of ingredients. Suggest the first recipe."})
