...
class Product(types.Product, BaseModel, extra=Extra.allow):
    ...
    id: Optional[int]  # 2351888
    name: Optional[str]  # "Cadbury Clinkers Lollies"
    brand: Optional[str]  # "Pascall"
    description: Optional[str]  # "PASCALL CADBURY CLINKERS 300G"
    size: Optional[str]  # "300g"
    availability: Optional[bool]  # true
    availabilityType: Optional[str]  # "InStoreAndOnline"
